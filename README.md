...
Возможно, добавление слоя Normalize вместо слоя Dropout или рядом с ним может привести к улучшению метрик.
...
#### Добавление нелинейности в классификационную голову
В качестве эксперимента можно попробовать добавить активационный слой (протестировать несколько разных типов) между слоями классификационной головы.
