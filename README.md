...
На текущий момент удалось достичь метрики weighted F1-score на уровне 0.64. Улучшение достигнуто за счет комплексного подхода к обработке данных, аугментации, выбора архитектуры модели и экспериментов с гиперпараметрами.
